...
# REMOTE_COMMAND="export ENV_PATH=../.env UID && cd $PROJECT_DIR_NAME/docker && docker-compose up -d --build && docker-compose logs -f"
REMOTE_COMMAND="export ENV_PATH=../.env && cd $PROJECT_DIR_NAME/docker && docker-compose up -d --build && docker-compose logs -f"
